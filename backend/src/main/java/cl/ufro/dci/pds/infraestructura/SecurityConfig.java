...
import cl.ufro.dci.pds.usuarios_permisos.infraestructura.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // IMPORTANTE para cookies/auth headers
